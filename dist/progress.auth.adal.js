...
var _jsdo = __webpack_require__(1);

//define azure session
if (typeof Object.defineProperty == 'function') Object.defineProperty(_jsdo.progress.data.Session, 'AUTH_TYPE_ADAL', {
    value: "adal", enumerable: true
});else _jsdo.progress.data.Session.AUTH_TYPE_ADAL = "adal";
 ...
 * Version: 0.0.0-dev
 */
var authProviderBase = _jsdo.progress.data.AuthenticationProvider;
_jsdo.progress.data.AuthenticationProvider = function (initObject) {
    var authProv,
        authModel = initObject && initObject.authenticationModel.toLowerCase(),
        adalConfig = initObject && initObject.adalConfig;
    switch (authModel) {
        case _jsdo.progress.data.Session.AUTH_TYPE_ADAL:
            authProv = new _jsdo.progress.data.AuthenticationProviderAdal(adalConfig);
            break;
        default:
...
var sessionBase = _jsdo.progress.data.Session;
_jsdo.progress.data.Session = function Session(options) {
    var that = this;
    ...
    if (typeof Object.defineProperty == 'function') {
        ...
        Object.defineProperty(that, 'authenticationModel', {
            ...
            set: function set(newval) {
                ...
                switch (newval) {
                    case _jsdo.progress.data.Session.AUTH_TYPE_FORM:
                    case _jsdo.progress.data.Session.AUTH_TYPE_BASIC:
                    case _jsdo.progress.data.Session.AUTH_TYPE_ANON:
                    case _jsdo.progress.data.Session.AUTH_TYPE_ADAL:
                    case null:
...
_jsdo.progress.data.Session.prototype = sessionBase.prototype;

exports.default = _jsdo.progress;
